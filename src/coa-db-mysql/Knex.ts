...
declare module 'knex' {
  interface QueryBuilder {
    ...
    filter<TRecord, TResult> (data: Dic<string | number>): Knex.QueryBuilder<TRecord, TResult>
...
Knex.QueryBuilder.extend('filter', function (data: Dic<string | number>) {
  return this.where(_.pickBy(data))
})
